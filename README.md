...
| TGA (`tga_artg.csv`) — partial scrape | 97,593 products | 55,632 (57.0%) | 41,961 (43.0%) | Registration dates are on individual ARTG product pages, not the listing page; full per-product scrape needed |
