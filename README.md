...
| TGA (`tga_artg.csv`) — partial scrape | 97,593 products | 34,132 (35.0%) | 63,461 (65.0%) | Registration dates are on individual ARTG product pages, not the listing page; full per-product scrape needed |
