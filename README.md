...
| TGA (`tga_artg.csv`) — partial scrape | 97,593 products | 74,632 (76.5%) | 22,961 (23.5%) | Registration dates are on individual ARTG product pages, not the listing page; full per-product scrape needed |
