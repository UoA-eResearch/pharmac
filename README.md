...
| TGA (`tga_artg.csv`) — partial scrape | 97,593 products | 65,132 (66.7%) | 32,461 (33.3%) | Registration dates are on individual ARTG product pages, not the listing page; full per-product scrape needed |
