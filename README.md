...
| TGA (`tga_artg.csv`) — partial scrape | 97,593 products | 95,632 (98.0%) | 1,961 (2.0%) | Registration dates are on individual ARTG product pages, not the listing page; full per-product scrape needed |
