...
| TGA (`tga_artg.csv`) — partial scrape | 97,593 products | 86,632 (88.8%) | 10,961 (11.2%) | Registration dates are on individual ARTG product pages, not the listing page; full per-product scrape needed |
